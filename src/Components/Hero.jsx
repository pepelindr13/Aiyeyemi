  ...
  return (
    <div>
      ...
      <h6 style={{lineHeight:"15px"}}>
        ...
        <h1 className="mt-4">Feat<span className="rse">ured Roo</span>ms</h1>
        <div className="rooms">
      ...
      <div className="about w-100">
        <div className="">
          ...
          <button className="bookBtn mt-3">BOOK A ROOM NOW</button>
        </div>
        <div className=" rightAbout">
          ...
          >
            <div class="carousel-inner topRight">
              ...
              <div class="carousel-item" data-bs-interval="2100">
                <img src={About1} class="d-block w-100" alt="..." />
              </div>
          ...
          <div
            ...
            data-bs-ride="carousel"
          >
            <div class="carousel-inner topLeft">
      ...
      <h6 style={{lineHeight:"15px"}}>
        ...
        <h1 className="mt-4">Explore <span className="rse">Our Hotel</span> Services</h1>
